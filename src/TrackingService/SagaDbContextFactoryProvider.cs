...
namespace TrackingService
{
    ...
    public static class SagaDbContextFactoryProvider
    {
        ...
        {
            @"Data Source=(LocalDb)\MSSQLLocalDB;Integrated Security=True;Initial Catalog=MtCourier;",
            // the localdb installed with VS 2015
            @"Data Source=(LocalDb)\ProjectsV12;Integrated Security=True;Initial Catalog=MtCourier;",
            // the localdb with VS 2013
            @"Data Source=(LocalDb)\v11.0;Integrated Security=True;Initial Catalog=MtCourier;"
